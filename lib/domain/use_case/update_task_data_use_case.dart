...
class UpdateTaskDataUseCase extends BaseUseCase<BaseTaskData,TaskParameter>{
  final BaseAppRepository baseAppRepository;


  UpdateTaskDataUseCase(this.baseAppRepository);

  @override
  Future<Either<Failure, BaseTaskData>> call(TaskParameter parameter) async{
    return await baseAppRepository.updateTaskData(parameter);
  }
